...
using System.IO;
using CodeSage.Core.Health.Models;
using CodeSage.Core.Health.Interfaces;
using CodeSage.Core.Health.Exceptions;
using CodeSageStatus = CodeSage.Core.Health.Models.HealthStatus;
...
public class ServiceHealthCheck : IHealthCheck, IDisposable
{
    ...
    private readonly CodeSageOptions _codeSageOptions;
        ...
        IEnumerable<ICustomHealthCheck> customChecks)
    {
        ...
        _codeSageOptions = codeSageOptions.Value;
        _serviceStatus = new();
    ...
    public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
    {
        ...
        foreach (var customCheck in _customChecks)
        {
            try
            {
                ...
                var status = isHealthy ? Microsoft.Extensions.Diagnostics.HealthChecks.HealthStatus.Healthy : Microsoft.Extensions.Diagnostics.HealthChecks.HealthStatus.Unhealthy;
