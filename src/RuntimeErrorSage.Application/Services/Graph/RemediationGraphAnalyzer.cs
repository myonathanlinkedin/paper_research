...
namespace RuntimeErrorSage.Model.Services.Graph
{
    ...
    public class RemediationGraphAnalyzer : IRemediationGraphAnalyzer
    {
        ...
        public async Task<RuntimeErrorSage.Model.Models.Graph.ComponentHealth> AnalyzeComponentHealthAsync(string componentId)
        {
            return new RuntimeErrorSage.Model.Models.Graph.ComponentHealth
            {
