...
namespace RuntimeErrorSage.Model.Services;
...
public class ImpactAnalyzer : IImpactAnalyzer
{
    ...
    /// <inheritdoc />
    public async Task<List<RuntimeErrorSage.Model.Models.Graph.ImpactAnalysisResult>> AnalyzeImpactAsync(ErrorContext context, DependencyGraph graph)
    {
        ...
        try
        {
            ...
            var results = new List<RuntimeErrorSage.Model.Models.Graph.ImpactAnalysisResult>();
    ...
    private async Task<RuntimeErrorSage.Model.Models.Graph.ImpactAnalysisResult> AnalyzeNodeImpactAsync(GraphNode node, DependencyGraph graph, string startNodeId)
    {
        try
        {
            var result = new RuntimeErrorSage.Model.Models.Graph.ImpactAnalysisResult
            {
