...
using RuntimeErrorSage.Model.Runtime.Exceptions;
...
public class RuntimeErrorSageService : IRuntimeErrorSageService
{
    ...
    private readonly RuntimeErrorSage.Model.Analysis.Interfaces.IDependencyGraphAnalyzer _graphAnalyzer;
    ...
    public RuntimeErrorSageService(
        ...
        RuntimeErrorSage.Model.Analysis.Interfaces.IDependencyGraphAnalyzer graphAnalyzer)
    {
    ...
    /// <inheritdoc />
    public void RegisterRemediationStrategy(RuntimeErrorSage.Model.Models.Remediation.Interfaces.IRemediationStrategy strategy)
    {
        try
        {
