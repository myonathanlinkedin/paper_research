...
{
    /// <summary>
    /// Implements the real-world error cases required by the research paper.
    /// Contains 20 real-world test cases collected from production applications.
    /// </summary>
    public class RealWorldErrorCases
    {
        ...
        public RealWorldErrorCases(ICodeSageService codeSageService)
        {
        ...
        private async Task<ErrorAnalysisResult> ExecuteScenario(RealWorldScenario scenario)
        {
            ...
            catch (Exception ex)
            {
                ...
                var context = new ErrorContext
                {
                    ...
                    AdditionalContext = scenario.Metadata
                };

                // Process the error through CodeSage
                return await _codeSageService.ProcessExceptionAsync(ex, context);
            }
        }
