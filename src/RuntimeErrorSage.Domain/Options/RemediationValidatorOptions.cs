...
namespace RuntimeErrorSage.Application.Options
{
    ...
    public class RemediationValidatorOptions
    {
        ...
        /// </summary>
        public bool EnableStrictValidation { get; } = true;

        /// <summary>
        /// Gets or sets the validation timeout.
        /// </summary>
        public TimeSpan ValidationTimeout { get; } = TimeSpan.FromMinutes(2);

        /// <summary>
        /// Gets or sets the maximum number of validation retries.
        /// </summary>
        public int MaxValidationRetries { get; } = 3;

        /// <summary>
        /// Gets or sets the default threshold for metric validation.
        /// </summary>
        public double DefaultMetricThreshold { get; } = 80.0; // 80% threshold by default
