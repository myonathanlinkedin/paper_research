...
{
    /// <summary>
    /// Implements the core RuntimeErrorSage service for runtime intelligence.
    /// </summary>
    public class RuntimeErrorSageService : IRuntimeErrorSageService
    {
        ...
        public async Task<ErrorContext> EnrichContextAsync(ErrorContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new RuntimeErrorSageException("Failed to enrich context", ex);
            }
        }
        ...
        public void Configure(RuntimeErrorSageOptions options)
        {
            ...
            _logger.LogInformation("RuntimeErrorSage service configured with options: {@Options}", options);
        }
        ...
        private ErrorAnalysisResult ParseLLMResponse(string llmResponse, Exception exception, ErrorContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new RuntimeErrorSageException("Failed to parse LLM response", ex);
            }
        }
        ...
        public async Task<ErrorAnalysisResult> AnalyzeErrorAsync(ErrorContext context)
        {
            try
            {
                ...
                var result = await _errorAnalyzer.AnalyzeAsync(context);
        ...
        public async Task<RemediationResult> RemediateErrorAsync(ErrorContext context)
        {
            try
            {
                ...
                var result = await _remediationExecutor.ExecuteRemediationAsync(analysis, context);
        ...
        public async Task<ValidationResult> ValidateContextAsync(ErrorContext context)
        {
            ...
            {
                throw new InvalidOperationException("Validation registry is not configured");
            }

            try
            {
                _logger.LogInformation("Validating error context: {ContextId}", context.Id);
                return await _validationRegistry.ValidateAsync(context);
            }
            catch (Exception ex)
            {
        ...
        public async Task<GraphAnalysisResult> AnalyzeContextGraphAsync(ErrorContext context)
        {
            ...
            {
                _logger.LogError(ex, "Error analyzing context graph: {ContextId}", context.Id);
                throw;
            }
        }
        ...
        public async Task<LLMAnalysisResult> AnalyzeWithLLMAsync(ErrorContext context)
        {
            ...
            try
            {
                ...
                return await _llmClient.AnalyzeErrorAsync(context);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error analyzing with LLM: {ContextId}", context.Id);
                throw;
            }
        }
    }
